...
#include "StackBrainSpec.h"
#include "StackBrainOpcodes.h"
#include "Errors.h"
#include "StackBrain.h"
...
GBLabel::GBLabel()
	: GBSymbol(), address(-1), gensym(false), referenced(false)
{}
